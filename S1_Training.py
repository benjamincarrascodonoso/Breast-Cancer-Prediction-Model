...
dirs = glob('./datasets/S1/train/*/', recursive=True)
for dir in dirs:
...
with open('./files/S1/History1Dict', 'wb') as file:
...
with open('./files/S1/History2Dict', 'wb') as file:
...
checkpoint = tf.keras.callbacks.ModelCheckpoint(
    filepath='./models/S1_model.h5',
    monitor='val_loss',
    save_best_only=True,
    verbose=1
)

print('[INFO] Starting 187 epochs training')
...
with open('./files/S1/History3Dict', 'wb') as file:
