...
with open('./files/S1-Big/History1Dict', 'wb') as file:
...
with open('./files/S1-Big/History2Dict', 'wb') as file:
...
checkpoint = tf.keras.callbacks.ModelCheckpoint(
    filepath='./models/S1-Big_model.h5',
    monitor='val_loss',
    save_best_only=True,
    verbose=1
)
...
with open('./files/S1-Big/History3Dict', 'wb') as file:
